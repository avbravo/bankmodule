...
@ViewScoped
@Data
public class BuscarCajeroProgramarEventoController implements Serializable, Page {
...
// </editor-fold>
     ...
     */
    public BuscarCajeroProgramarEventoController() {
    }
...
// </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="String onCommandButtonRegresarToProgramarEvento">

    public String onCommandButtonRegresarToProgramarEvento() {
        try {
...
// </editor-fold>
    ...
    public void deleteProgramarEvento() {
        ...
        try {
            ...
            PrimeFaces.current().ajax().update("form:growl", "form:dataTable", ":form:selectOneMenuCajeroAdd", ":form:direccion");
        } catch (Exception e) {
            JsfUtil.errorMessage(JsfUtil.nameOfMethod() + " " + e.getLocalizedMessage());
        }
